  ...
  //Reciever mac adress
  uint8_t gloveAddress[] = {0xb8, 0xf8, 0x62, 0xd6, 0x52, 0x8c}; //XIAO glove standin
  ...
  {
    memcpy(&inMidi, incomingData, sizeof(inMidi));
    Serial.println("MIDI data revieved:");

    if(inMidi.toggle1 == true) MIDI.sendNoteOn(0, 127, 1); //Note 0, velcity 127, channel 1
    else if(inMidi.toggle1 == false) MIDI. sendNoteOff(0, 127, 1);
